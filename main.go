...
// this function is to set json response
...
func main() {
	...
	// init DB
	database["001"] = Product{ID: "001", Name: "Macbook Pro 2019", Quantity: 20}
	database["002"] = Product{ID: "002", Name: "Macbook Air 2019", Quantity: 15}
	...
	http.HandleFunc("/delete-product", func(res http.ResponseWriter, req *http.Request) {
		...
		// message := []byte(`{"message":"success delete product"}`)
		SetJSONResp(res, productJSON, http.StatusOK)
